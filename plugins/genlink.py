...
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("Use Correct Format \nExplample ›› <code>/batch https://t.me/Movies_Unloaded2 https://t.me/Movies_Unloaded2</code>.")
    links = message.text.strip().split(" ")
    if len(links) != 3:
        return await message.reply("Use correct format.\nExample <code>/batch https://t.me/Movies_Unloaded2 https://t.me/Movies_Unloaded2</code>.")
    ...
    try:
        ...
        return await message.reply('This Maybe A Private Channel or group make sure i am admin in that group')
    except (UsernameInvalid, UsernameNotModified):
        return await message.reply('Invalid Link specified.')
    except Exception as e:
        return await message.reply(f'Errors - {e}')

    sts = await message.reply("Generating link for you.\n This Process may take time depends on number of files.")
